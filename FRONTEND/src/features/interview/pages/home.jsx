...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        if (!jobDescription.trim() || (!resumeFile && !selfDescription.trim())) {
            setError("Add a job description and either a PDF resume or self-description.")
            return
        }
        ...
        try {
            ...
            setError(requestError.response?.data?.message || "Unable to generate an interview strategy. Please try again.")
        }
    }
                ...
                <div className='interview-card__body'>
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <div
                                className={`dropzone ${resumeFile ? 'dropzone--active' : ''}`}
                                role='button'
                                tabIndex={0}
                            ...
                            {resumeFile && (
                                <div className='uploaded-resume'>
                                    ...
                                    <button type='button' onClick={clearResume}>Remove</button>
                                </div>
                            )}
                        </div>
